...
router = APIRouter(prefix="domen.com/api/products", tags=["products"])
...
@router.get("/category/{category_id}", response_model=List[ProductListResponse], status_code=status.HTTP_200_OK)
